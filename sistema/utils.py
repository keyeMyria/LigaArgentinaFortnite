...
def finalizar_torneo_black_pan_rq():
        ...
        for user in usuarios:
            if user.postkills_1 == 0:
                ...
                stats1 = run_query(query_u1)
                stats2 = run_query(query_u2)
                postkills_1 = stats1['data']['player']['segments'][0]['stats'][0]['value']
                postwins_1 = stats1['data']['player']['segments'][0]['stats'][3]['value']
                posttop5_1 = stats1['data']['player']['stats'][5]['value']
                postpartidas_1 = stats1['data']['player']['segments'][0]['stats'][2]['value']
                postkills_2 = stats2['data']['player']['segments'][0]['stats'][0]['value']
                postwins_2 = stats2['data']['player']['segments'][0]['stats'][3]['value']
                postpartidas_2 = stats2['data']['player']['segments'][0]['stats'][2]['value']
                postwins_1 = int(postwins_1)
                postwins_2 = int(postwins_2)
                postkills_1 = int(postkills_1)
                postkills_2 = int(postkills_2)
