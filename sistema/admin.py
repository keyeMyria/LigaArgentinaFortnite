...
def resetear_todo(modeladmin, request, queryset):
    ...
    Perfil.objects.update(kills_totales='0', wins_totales='0', kills_liga='0', partidas_liga='0', partidas_totales='0', pretop5_1='0', posttop5_1='0', top5_1='0')
...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('username', 'first_name', 'last_name', 'get_team','email', 'date_joined', 'get_ver', 'get_kills', 'get_kills2')
