...
class SignupForm(forms.Form):
    ...
    equipo = forms.CharField(max_length=30, label='Equipo (si tiene)', required=False, widget=forms.TextInput(attrs={ 'class': 'input' ,'placeholder':('Equipo'),'autofocus': 'autofocus'}))
