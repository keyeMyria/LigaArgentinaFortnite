...
class LoginForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if app_settings.AUTHENTICATION_METHOD == AuthenticationMethod.EMAIL:
            login_widget = forms.TextInput(attrs={ 'class': 'input' ,'type': 'email',
                                                  'placeholder':
                                                  _('E-mail'),
                                                  'autofocus': 'autofocus'})
            ...
            login_widget = forms.TextInput(attrs={ 'class': 'input' ,'placeholder':
                                                  _('Username'),
                                                  'autofocus': 'autofocus'})
...
class BaseSignupForm(_base_signup_form_class()):
    ...
    #plataforma = forms.CharField(label=_("plataforma"),
    #                           min_length=app_settings.USERNAME_MIN_LENGTH,
    #                           widget=forms.TextInput(
    #                               attrs={ 'class': 'input' ,'placeholder':
    #                                      _('plat'),
    #                                      'autofocus': 'autofocus'}))
    username = forms.CharField(label=_("USUARIO DE EPIC GAMES (Reevisa que tu usuario este bien escrito)(No PSN!)"),
                               min_length=app_settings.USERNAME_MIN_LENGTH,
                               widget=forms.TextInput(
                                   attrs={ 'class': 'input' ,'placeholder':
