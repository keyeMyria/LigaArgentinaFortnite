...
class SignupForm(forms.Form):
    black_pan = forms.ChoiceField(label='Soy de Cordoba y quiero participar del torneo BLACK PAN (SOLO PS4!)', choices= ( ('SI', 'SI'), ('NO', 'NO'), ) ,widget=forms.Select(attrs={ 'class': 'input','autofocus': 'autofocus'}))
