...
class SignupForm(forms.Form):
    black_pan = forms.ChoiceField(Label(frame1, text="Soy de Cordoba y quiro participar del torneo BLACK PAN", font=('bold')), choices= ( ('NO', 'NO'), ('SI', 'SI'), ) ,widget=forms.Select(attrs={ 'class': 'input','autofocus': 'autofocus'}))
